...
public class PlanetTest : MonoBehaviour
{
    ...
    // Maximális ütemezési idő a power-up létrehozására
    private float maxSpawnRateInSeconds = 5f; // Definiáljuk a változót
    ...
    void SpawnPowerUp()
    {
        ...
        // Létrehozás véletelnszerű helyen a határok között
        aPowerUp.transform.position = new Vector2(Random.Range(min.x, max.x), max.y);

        // Következő tárgy rekurzív ütemezése
    ...
    public void Setup()
    {
        ...
        // Fő kamerát hozunk létre és pozícionáljuk
        GameObject cameraGO = new GameObject("MainCamera");
        Camera cameraComponent = cameraGO.AddComponent<Camera>();
        cameraGO.tag = "MainCamera"; // Ez teszi "fő kamerává" a teszt során
